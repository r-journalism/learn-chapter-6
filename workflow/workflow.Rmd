...
This is from the [sixth chapter](https://learn.r-journalism.com/en/publishing/workflow/r-projects/) of [learn.r-journalism.com](https://learn.r-journalism.com/).
...
<img src="images/project.png" alt="Projects in RStudio", class="shadow", style="width:70%">

#### Do not dump your scripts into a folder


<img src="images/folder_rscripts.png" alt="Cut the cord", class="shadow", style="width:70%">
...
<img src="images/multiple_projects.png" alt="Cut the cord", class="shadow", style="width:70%">
...
<img src="images/cut_the_cord.png" alt="Cut the cord", class="shadow", style="width:70%">
